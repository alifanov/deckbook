...
import { Back, Banner, Icon, Markdown, moment, ProjectNav, Reveal } from "../../../../../ui";
  ...
  return (
    <>
      ...
      <main>
        ...
        <div className="panes">
          <DocumentTree tree={tree} slug={slug} activeId={id} />
          ...
          <section>
            {editing ? (
              ...
              <>
                ...
                {document.isFolder ? (
                  <p className="muted">Папка. Её содержимое видно в дереве слева.</p>
